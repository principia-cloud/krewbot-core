// Core default: the sidebar footer's community link (Discord invite).
// Overlays that don't want a community CTA (e.g. a single-tenant
// deployment) replace this impl with a null-rendering stub.
export function CommunityLink() {
  return (
    <a
      href="https://discord.gg/GbKa523S8"
      target="_blank"
